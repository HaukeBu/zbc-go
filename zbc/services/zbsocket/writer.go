...
// MessageWriter is builder which will take zbdispatch.Message pointer and create valid byte array.
type MessageWriter struct {
	message *zbdispatch.Message
}
...
func NewMessageWriter(message *zbdispatch.Message) *MessageWriter {
